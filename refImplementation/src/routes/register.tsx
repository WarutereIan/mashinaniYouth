...
import { ShieldCheck, IdCard, CheckCircle2 } from "lucide-react";
...
import { getVoter, registerVoter, signOutVoter } from "@/lib/voter-store";
import {
  COUNTY_NAMES,
...
export const Route = createFileRoute("/register")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Register on the MY-KDM electronic voter roll with your National ID." },
    ],
  }),
      ...
      <section className="mx-auto grid max-w-6xl gap-10 px-4 py-14 sm:px-6 md:grid-cols-[1fr_1.1fr]">
        ...
        >
          ...
          <p className="mt-4 text-xs text-muted-foreground">
            By registering you agree to the MY-KDM code of conduct. This is a demo voter roll; no data
            leaves your device.
          </p>
        </form>
      </section>
