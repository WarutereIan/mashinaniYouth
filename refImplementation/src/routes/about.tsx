...
function AboutPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="border-b border-border bg-gradient-to-b from-primary/5 to-background">
        <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 md:py-24">
          ...
          <p className="mt-6 max-w-2xl text-base text-muted-foreground md:text-lg">
            A nationwide youth movement with a national youth leadership structure — built from
            the ward level upward and elected by young people themselves through this platform.
          </p>
        </div>
      </section>

      {/* Background */}
      <Section eyebrow="01 · Background" title={<><span className="text-ink">Why this</span> <span className="text-gradient-gold">movement</span> <span className="text-accent">exists</span></>}>
        <p>
        ...
        <p>
          ...
          youth movement with a national youth leadership structure, built from the ward upward
          and elected end-to-end on this platform using electronic voting — fast, verifiable and
          accessible across all 47 counties.
        </p>
      </Section>

      {/* Vision */}
      <Section eyebrow="02 · Vision" title={<><span className="text-ink">Our</span> <span className="text-gradient-gold">vision</span></>} tone="alt">
        <p>
      ...
      {/* Mission */}
      <Section eyebrow="03 · Mission" title={<><span className="text-ink">Our</span> <span className="text-accent">mission</span></>}>
        <p>
          To build a transparent, competitive and digitally-run national youth structure that
          identifies capable young leaders, amplifies youth priorities, and converts that voice
          into partnerships, opportunities and policy influence.
        </p>
      </Section>
      ...
      {/* Partners */}
      <Section eyebrow="05 · Strategic partners" title={<><span className="text-ink">Built</span> <span className="text-gradient-gold">with</span> <span className="text-accent">purpose</span></>}>
      ...
      {/* Roadmap */}
      <Section eyebrow="06 · Roadmap" title={<><span className="text-ink">Launch.</span> <span className="text-gradient-gold">Build.</span> <span className="text-accent">Empower.</span></>} tone="alt">
      ...
      <Section
        eyebrow="07 · Connect"
        title={<><span className="text-ink">Follow the</span> <span className="text-gradient-gold">movement</span></>}
      >
        <p>
        ...
        <div className="mt-6 grid gap-3 sm:grid-cols-2">
          ...
          <div className="grid grid-cols-4 gap-3">
            {[
              { Icon: FaFacebook, label: "Facebook", href: "https://facebook.com/mashinaniyouthmovement", color: "#1877F2" },
              { Icon: FaXTwitter, label: "X (Twitter)", href: "https://x.com/mymkenya", color: "#000000" },
              { Icon: FaInstagram, label: "Instagram", href: "https://instagram.com/mashinaniyouthmovement", color: "#E4405F" },
              { Icon: FaYoutube, label: "YouTube", href: "https://youtube.com/@mashinaniyouthmovement", color: "#FF0000" },
    ...
    <section id="secretariat" className="scroll-mt-24 border-y border-border bg-ink text-white">
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
        ...
        <p className="mt-3 max-w-2xl text-sm text-white/70">
          Chair, CEO and the Cabinet of Youth Ministers — the elected national leadership
          driving MY-KDM's delivery agenda.
        </p>
      </div>
