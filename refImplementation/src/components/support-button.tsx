        ...
        {submitted ? (
          <div className="rounded-xl border border-primary/30 bg-primary/5 p-5 text-sm">
            ...
            <p className="mt-1 text-muted-foreground">
              We've received your intent to {mode === "donate" ? `contribute KES ${chosen.toLocaleString()}` : mode === "partner" ? "partner with MY-KDM" : "support the movement"}.
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              <div>
                ...
                <Input id="phone" value={phone} onChange={(e) => setPhone(e.target.value)} placeholder="07…" className="mt-1" />
              </div>
            </div>
            <div>
            ...
            {mode !== "donate" && (
              <div>
                <Label htmlFor="message" className="text-xs">
                  {mode === "partner" ? "How would you like to partner?" : "How would you like to support?"}
                </Label>
                <Textarea
                  id="message"
                  value={message}
                  ...
                  rows={3}
                  className="mt-1"
                  placeholder={mode === "partner" ? "e.g. corporate sponsorship, in-kind, media…" : "e.g. volunteer, mentor, share the movement…"}
                />
              </div>
            )}

            <Button type="submit" size="lg" className="w-full bg-gradient-gold">
              {mode === "donate"
